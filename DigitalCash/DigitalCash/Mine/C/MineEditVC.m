...
@interface MineEditVC ()<UITableViewDataSource, UITableViewDelegate, MineInformationNameViewDelegate, MineInformationSexViewDelegate, MineEditProfileCellDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,TZImagePickerControllerDelegate, YPNavigationBarConfigureStyle>
...
- (void)setAvatarImg
{
     [_avatarImgView sd_setImageWithURL:[NSURL URLWithString:_user.head]
       placeholderImage:[UIImage imageNamed:@"avatar_big"]];
}
...
//            customStyle.pickerTextColor = [UIColor colorWithHexString:@"#5C5C5C"];
            customStyle.pickerTextFont = [UIFont systemFontOfSize:16 weight:UIFontWeightMedium];
            customStyle.selectRowTextColor = [UIColor colorWithHexString:@"#F85B3A"];
            customStyle.titleTextColor = [UIColor colorWithHexString:@"#1D0F01"];
            customStyle.titleTextFont = [UIFont systemFontOfSize:16 weight:UIFontWeightMedium];
            customStyle.cancelTextColor = [UIColor colorWithHexString:@"#7F7F7F"];
            customStyle.doneTextColor = [UIColor colorWithHexString:@"#F85B3A"];
...
#pragma mark - Add&RemoveCoverView
...
-(void)setUser{
    ...
    [ENDNetWorkManager putWithPathUrl:@"/user/personal/updateUser" parameters:dic queryParams:nil Header:nil success:^(BOOL success, id result) {
        [Toast makeText:weakSelf.view Message:@"修改成功！" afterHideTime:DELAYTiME];
